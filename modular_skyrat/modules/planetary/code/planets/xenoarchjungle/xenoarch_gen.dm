...
#define XENOARCH_BIOME_RANDOM_SQUARE_DRIFT 2

/datum/map_generator/xenoarchjungle_generator
...
/datum/map_generator/xenoarchjungle_generator/generate_terrain(list/turfs)
	. = ..()
	...
	for(var/t in turfs) //Go through all the turfs and generate them
		var/turf/gen_turf = t
		var/drift_x = (gen_turf.x + rand(-XENOARCH_BIOME_RANDOM_SQUARE_DRIFT, XENOARCH_BIOME_RANDOM_SQUARE_DRIFT)) / perlin_zoom
		var/drift_y = (gen_turf.y + rand(-XENOARCH_BIOME_RANDOM_SQUARE_DRIFT, XENOARCH_BIOME_RANDOM_SQUARE_DRIFT)) / perlin_zoom
